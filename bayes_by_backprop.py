...
from agents.bayes_by_backprop import BBB_learner
...
env.seed(seed)
agent = BBB_learner(state_size=env.observation_space.shape[0], action_size= env.action_space.n, seed=seed, hiddens = [24,24], args = args)
